...
## 1. O que mudou? (A Regra Permanente)

Para os servidores que ingressaram **após** a Reforma, a aposentadoria especial exige, além dos 25 anos de efetiva exposição a agentes nocivos, uma **idade mínima de 60 anos**. 

Isso acabou com a possibilidade de um enfermeiro, por exemplo, começar a trabalhar aos 20 anos de idade e se aposentar de forma especial aos 45.

## 2. A Regra de Transição (O Sistema de Pontos)

Se você já era servidor público **antes** da Reforma (novembro de 2019) e estava em atividade especial, você entra na regra de transição por pontos.

Para se aposentar, você precisa preencher os 25 anos de efetiva exposição E somar **86 pontos** (Idade + Tempo de Contribuição total). 

*A vantagem:* O tempo que você trabalhou em atividade não insalubre (comum) pode ser usado para ajudar a chegar nesses 86 pontos, reduzindo assim a idade necessária para se aposentar.

## 3. Como provar a Atividade Especial?

Não basta apenas ter recebido o adicional de insalubridade no contracheque. Para o RPPS e o INSS, a prova máxima da atividade especial é o documento chamado **PPP (Perfil Profissiográfico Previdenciário)**.
