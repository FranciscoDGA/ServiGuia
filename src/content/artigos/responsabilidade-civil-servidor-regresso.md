---
title: 'Responsabilidade Civil do Servidor Público (Processo de Regresso)'
...
Muitos servidores acreditam que, neste momento, o problema acabou. Acreditam que o Estado, por ser poderoso, arca com o prejuízo e a vida segue normalmente. É exatamente aí que o pesadelo se inicia para o servidor desavisado. Entra em cena a implacável **Ação de Regresso**.

Neste artigo extremamente detalhado, vamos destrinchar como funciona a responsabilidade civil do servidor, como se defender de acusações injustas e de que forma você pode proteger o seu patrimônio financeiro frente a falhas estruturais que a própria prefeitura tenta jogar nas suas costas.

> [!WARNING]
> Nunca ignore as notificações preliminares de sindicâncias internas. O processo que culmina na cobrança do servidor muitas vezes nasce silencioso dentro do RH e da Corregedoria do órgão.

## 1. A Vítima Pode Processar o Servidor Diretamente?

A resposta para essa pergunta gera enorme confusão e medo, mas a jurisprudência do Supremo Tribunal Federal (STF) trouxe grande segurança para o servidor recentemente. 
...
## 2. A Ação de Regresso: A Conta Chega para o Servidor
...
Ao contrário da responsabilidade do Estado para com a vítima (que é objetiva), a responsabilidade do servidor em face do Estado é **SUBJETIVA**. 

> [!IMPORTANT]
> A responsabilidade subjetiva é a sua salvação. Ela significa que a prefeitura **só conseguirá tirar um centavo do seu bolso se conseguir provar**, de forma cabal, que você agiu com **Dolo** ou com **Culpa Grave**.

- **Dolo:** É a intenção consciente e deliberada de causar o dano. Exemplo: um servidor, por raiva de um cidadão, pega a viatura e bate de propósito no carro dele.
